...
stdenv.mkDerivation {
  ...
  installPhase = ''
     ...
     install -Dm 644 cxgb4/t6fw-1.24.14.0.bin $out/lib/firmware/cxgb4/t6fw-1.24.14.0.bin
     install -Dm 644 cxgb4/t5fw-1.24.14.0.bin $out/lib/firmware/cxgb4/t5fw-1.24.14.0.bin
     ...
     install -Dm 644 cxgb4/t4fw-1.24.14.0.bin $out/lib/firmware/cxgb4/t4fw-1.24.14.0.bin
     ...
     ln -sv t6fw-1.24.14.0.bin $out/lib/firmware/cxgb4/t6fw.bin
     mkdir -p "$(dirname $out/lib/firmware/cxgb4/t5fw.bin)"
     ln -sv t5fw-1.24.14.0.bin $out/lib/firmware/cxgb4/t5fw.bin
     mkdir -p "$(dirname $out/lib/firmware/cxgb4/t4fw.bin)"
     ln -sv t4fw-1.24.14.0.bin $out/lib/firmware/cxgb4/t4fw.bin
...
stdenv.mkDerivation {
  ...
  installPhase = ''
     ...
     install -Dm 644 i915/skl_guc_ver6.bin $out/lib/firmware/i915/skl_guc_ver6.bin
     ...
     install -Dm 644 i915/kbl_dmc_ver1_04.bin $out/lib/firmware/i915/kbl_dmc_ver1_04.bin
     install -Dm 644 i915/kbl_dmc_ver1.bin $out/lib/firmware/i915/kbl_dmc_ver1.bin
     install -Dm 644 i915/kbl_dmc_ver1_01.bin $out/lib/firmware/i915/kbl_dmc_ver1_01.bin
     install -Dm 644 i915/bxt_dmc_ver1.bin $out/lib/firmware/i915/bxt_dmc_ver1.bin
     install -Dm 644 i915/bxt_dmc_ver1_07.bin $out/lib/firmware/i915/bxt_dmc_ver1_07.bin
     install -Dm 644 i915/skl_dmc_ver1.bin $out/lib/firmware/i915/skl_dmc_ver1.bin
...
stdenv.mkDerivation {
  ...
  installPhase = ''
     ...
     install -Dm 644 intel/ice/ddp/ice-1.3.4.0.pkg $out/lib/firmware/intel/ice/ddp/ice-1.3.4.0.pkg

     mkdir -p "$(dirname $out/lib/firmware/intel/ice/ddp/ice.pkg)"
     ln -sv ice-1.3.4.0.pkg $out/lib/firmware/intel/ice/ddp/ice.pkg
...
stdenv.mkDerivation {
  ...
  installPhase = ''
     ...
     install -Dm 644 iwlwifi-7265D-10.ucode $out/lib/firmware/iwlwifi-7265D-10.ucode
...
stdenv.mkDerivation {
  ...
  installPhase = ''
     ...
     install -Dm 644 nvidia/tu117/sec2/sig.bin $out/lib/firmware/nvidia/tu117/sec2/sig.bin
     install -Dm 644 nvidia/tu117/sec2/image.bin $out/lib/firmware/nvidia/tu117/sec2/image.bin
     install -Dm 644 nvidia/tu117/sec2/desc.bin $out/lib/firmware/nvidia/tu117/sec2/desc.bin
     install -Dm 644 nvidia/tu117/nvdec/scrubber.bin $out/lib/firmware/nvidia/tu117/nvdec/scrubber.bin
     ...
     install -Dm 644 nvidia/tu117/gr/gpccs_bl.bin $out/lib/firmware/nvidia/tu117/gr/gpccs_bl.bin
     ...
     install -Dm 644 nvidia/tu117/gr/fecs_bl.bin $out/lib/firmware/nvidia/tu117/gr/fecs_bl.bin
     install -Dm 644 nvidia/tu117/acr/unload_bl.bin $out/lib/firmware/nvidia/tu117/acr/unload_bl.bin
     install -Dm 644 nvidia/tu117/acr/ucode_unload.bin $out/lib/firmware/nvidia/tu117/acr/ucode_unload.bin
     install -Dm 644 nvidia/tu117/acr/ucode_asb.bin $out/lib/firmware/nvidia/tu117/acr/ucode_asb.bin
     install -Dm 644 nvidia/tu117/acr/ucode_ahesasc.bin $out/lib/firmware/nvidia/tu117/acr/ucode_ahesasc.bin
     install -Dm 644 nvidia/tu117/acr/bl.bin $out/lib/firmware/nvidia/tu117/acr/bl.bin
     ...
     install -Dm 644 nvidia/tu106/sec2/sig.bin $out/lib/firmware/nvidia/tu106/sec2/sig.bin
     install -Dm 644 nvidia/tu106/sec2/image.bin $out/lib/firmware/nvidia/tu106/sec2/image.bin
     install -Dm 644 nvidia/tu106/sec2/desc.bin $out/lib/firmware/nvidia/tu106/sec2/desc.bin
     install -Dm 644 nvidia/tu106/nvdec/scrubber.bin $out/lib/firmware/nvidia/tu106/nvdec/scrubber.bin
     ...
     install -Dm 644 nvidia/tu106/gr/gpccs_bl.bin $out/lib/firmware/nvidia/tu106/gr/gpccs_bl.bin
     ...
     install -Dm 644 nvidia/tu106/gr/fecs_bl.bin $out/lib/firmware/nvidia/tu106/gr/fecs_bl.bin
     install -Dm 644 nvidia/tu106/acr/ucode_unload.bin $out/lib/firmware/nvidia/tu106/acr/ucode_unload.bin
     install -Dm 644 nvidia/tu106/acr/unload_bl.bin $out/lib/firmware/nvidia/tu106/acr/unload_bl.bin
     install -Dm 644 nvidia/tu106/acr/ucode_asb.bin $out/lib/firmware/nvidia/tu106/acr/ucode_asb.bin
     install -Dm 644 nvidia/tu106/acr/ucode_ahesasc.bin $out/lib/firmware/nvidia/tu106/acr/ucode_ahesasc.bin
     install -Dm 644 nvidia/tu106/acr/bl.bin $out/lib/firmware/nvidia/tu106/acr/bl.bin
     install -Dm 644 nvidia/tu104/sec2/sig.bin $out/lib/firmware/nvidia/tu104/sec2/sig.bin
     install -Dm 644 nvidia/tu104/sec2/image.bin $out/lib/firmware/nvidia/tu104/sec2/image.bin
     install -Dm 644 nvidia/tu104/sec2/desc.bin $out/lib/firmware/nvidia/tu104/sec2/desc.bin
     install -Dm 644 nvidia/tu104/nvdec/scrubber.bin $out/lib/firmware/nvidia/tu104/nvdec/scrubber.bin
     ...
     install -Dm 644 nvidia/tu104/gr/gpccs_bl.bin $out/lib/firmware/nvidia/tu104/gr/gpccs_bl.bin
     ...
     install -Dm 644 nvidia/tu104/gr/fecs_bl.bin $out/lib/firmware/nvidia/tu104/gr/fecs_bl.bin
     install -Dm 644 nvidia/tu104/acr/ucode_unload.bin $out/lib/firmware/nvidia/tu104/acr/ucode_unload.bin
     install -Dm 644 nvidia/tu104/acr/unload_bl.bin $out/lib/firmware/nvidia/tu104/acr/unload_bl.bin
     install -Dm 644 nvidia/tu104/acr/ucode_asb.bin $out/lib/firmware/nvidia/tu104/acr/ucode_asb.bin
     install -Dm 644 nvidia/tu104/acr/ucode_ahesasc.bin $out/lib/firmware/nvidia/tu104/acr/ucode_ahesasc.bin
     install -Dm 644 nvidia/tu104/acr/bl.bin $out/lib/firmware/nvidia/tu104/acr/bl.bin
     ...
     install -Dm 644 nvidia/gp108/sec2/sig.bin $out/lib/firmware/nvidia/gp108/sec2/sig.bin
     install -Dm 644 nvidia/gp108/sec2/image.bin $out/lib/firmware/nvidia/gp108/sec2/image.bin
     install -Dm 644 nvidia/gp108/sec2/desc.bin $out/lib/firmware/nvidia/gp108/sec2/desc.bin
     install -Dm 644 nvidia/gp108/nvdec/scrubber.bin $out/lib/firmware/nvidia/gp108/nvdec/scrubber.bin
     ...
     install -Dm 644 nvidia/gp108/acr/unload_bl.bin $out/lib/firmware/nvidia/gp108/acr/unload_bl.bin
     install -Dm 644 nvidia/gp108/acr/ucode_unload.bin $out/lib/firmware/nvidia/gp108/acr/ucode_unload.bin
     install -Dm 644 nvidia/gp108/acr/ucode_load.bin $out/lib/firmware/nvidia/gp108/acr/ucode_load.bin
     install -Dm 644 nvidia/gp108/acr/bl.bin $out/lib/firmware/nvidia/gp108/acr/bl.bin
     ...
     install -Dm 644 nvidia/gp107/sec2/sig-1.bin $out/lib/firmware/nvidia/gp107/sec2/sig-1.bin
     install -Dm 644 nvidia/gp107/sec2/image-1.bin $out/lib/firmware/nvidia/gp107/sec2/image-1.bin
     install -Dm 644 nvidia/gp107/sec2/desc-1.bin $out/lib/firmware/nvidia/gp107/sec2/desc-1.bin
     install -Dm 644 nvidia/gp107/sec2/sig.bin $out/lib/firmware/nvidia/gp107/sec2/sig.bin
     install -Dm 644 nvidia/gp107/sec2/image.bin $out/lib/firmware/nvidia/gp107/sec2/image.bin
     install -Dm 644 nvidia/gp107/sec2/desc.bin $out/lib/firmware/nvidia/gp107/sec2/desc.bin
     install -Dm 644 nvidia/gp107/nvdec/scrubber.bin $out/lib/firmware/nvidia/gp107/nvdec/scrubber.bin
     install -Dm 644 nvidia/gp107/gr/sw_nonctx.bin $out/lib/firmware/nvidia/gp107/gr/sw_nonctx.bin
     install -Dm 644 nvidia/gp107/gr/sw_method_init.bin $out/lib/firmware/nvidia/gp107/gr/sw_method_init.bin
     install -Dm 644 nvidia/gp107/gr/sw_ctx.bin $out/lib/firmware/nvidia/gp107/gr/sw_ctx.bin
     install -Dm 644 nvidia/gp107/gr/sw_bundle_init.bin $out/lib/firmware/nvidia/gp107/gr/sw_bundle_init.bin
     ...
     install -Dm 644 nvidia/gp107/acr/unload_bl.bin $out/lib/firmware/nvidia/gp107/acr/unload_bl.bin
     install -Dm 644 nvidia/gp107/acr/ucode_unload.bin $out/lib/firmware/nvidia/gp107/acr/ucode_unload.bin
     install -Dm 644 nvidia/gp107/acr/ucode_load.bin $out/lib/firmware/nvidia/gp107/acr/ucode_load.bin
     install -Dm 644 nvidia/gp107/acr/bl.bin $out/lib/firmware/nvidia/gp107/acr/bl.bin
     install -Dm 644 nvidia/gp106/sec2/sig-1.bin $out/lib/firmware/nvidia/gp106/sec2/sig-1.bin
     install -Dm 644 nvidia/gp106/sec2/image-1.bin $out/lib/firmware/nvidia/gp106/sec2/image-1.bin
     install -Dm 644 nvidia/gp106/sec2/desc-1.bin $out/lib/firmware/nvidia/gp106/sec2/desc-1.bin
     install -Dm 644 nvidia/gp106/sec2/sig.bin $out/lib/firmware/nvidia/gp106/sec2/sig.bin
     install -Dm 644 nvidia/gp106/sec2/image.bin $out/lib/firmware/nvidia/gp106/sec2/image.bin
     install -Dm 644 nvidia/gp106/sec2/desc.bin $out/lib/firmware/nvidia/gp106/sec2/desc.bin
     install -Dm 644 nvidia/gp106/nvdec/scrubber.bin $out/lib/firmware/nvidia/gp106/nvdec/scrubber.bin
     install -Dm 644 nvidia/gp106/gr/sw_nonctx.bin $out/lib/firmware/nvidia/gp106/gr/sw_nonctx.bin
     install -Dm 644 nvidia/gp106/gr/sw_method_init.bin $out/lib/firmware/nvidia/gp106/gr/sw_method_init.bin
     install -Dm 644 nvidia/gp106/gr/sw_ctx.bin $out/lib/firmware/nvidia/gp106/gr/sw_ctx.bin
     install -Dm 644 nvidia/gp106/gr/sw_bundle_init.bin $out/lib/firmware/nvidia/gp106/gr/sw_bundle_init.bin
     install -Dm 644 nvidia/gp106/gr/gpccs_sig.bin $out/lib/firmware/nvidia/gp106/gr/gpccs_sig.bin
     install -Dm 644 nvidia/gp106/gr/gpccs_inst.bin $out/lib/firmware/nvidia/gp106/gr/gpccs_inst.bin
     install -Dm 644 nvidia/gp106/gr/gpccs_data.bin $out/lib/firmware/nvidia/gp106/gr/gpccs_data.bin
     install -Dm 644 nvidia/gp106/gr/gpccs_bl.bin $out/lib/firmware/nvidia/gp106/gr/gpccs_bl.bin
     install -Dm 644 nvidia/gp106/gr/fecs_sig.bin $out/lib/firmware/nvidia/gp106/gr/fecs_sig.bin
     install -Dm 644 nvidia/gp106/gr/fecs_inst.bin $out/lib/firmware/nvidia/gp106/gr/fecs_inst.bin
     install -Dm 644 nvidia/gp106/gr/fecs_data.bin $out/lib/firmware/nvidia/gp106/gr/fecs_data.bin
     install -Dm 644 nvidia/gp106/gr/fecs_bl.bin $out/lib/firmware/nvidia/gp106/gr/fecs_bl.bin
     install -Dm 644 nvidia/gp106/acr/unload_bl.bin $out/lib/firmware/nvidia/gp106/acr/unload_bl.bin
     install -Dm 644 nvidia/gp106/acr/ucode_unload.bin $out/lib/firmware/nvidia/gp106/acr/ucode_unload.bin
     install -Dm 644 nvidia/gp106/acr/ucode_load.bin $out/lib/firmware/nvidia/gp106/acr/ucode_load.bin
     install -Dm 644 nvidia/gp106/acr/bl.bin $out/lib/firmware/nvidia/gp106/acr/bl.bin
     install -Dm 644 nvidia/gp104/sec2/sig-1.bin $out/lib/firmware/nvidia/gp104/sec2/sig-1.bin
     install -Dm 644 nvidia/gp104/sec2/image-1.bin $out/lib/firmware/nvidia/gp104/sec2/image-1.bin
     install -Dm 644 nvidia/gp104/sec2/desc-1.bin $out/lib/firmware/nvidia/gp104/sec2/desc-1.bin
     install -Dm 644 nvidia/gp104/sec2/sig.bin $out/lib/firmware/nvidia/gp104/sec2/sig.bin
     install -Dm 644 nvidia/gp104/sec2/image.bin $out/lib/firmware/nvidia/gp104/sec2/image.bin
     install -Dm 644 nvidia/gp104/sec2/desc.bin $out/lib/firmware/nvidia/gp104/sec2/desc.bin
     install -Dm 644 nvidia/gp104/nvdec/scrubber.bin $out/lib/firmware/nvidia/gp104/nvdec/scrubber.bin
     install -Dm 644 nvidia/gp104/gr/sw_nonctx.bin $out/lib/firmware/nvidia/gp104/gr/sw_nonctx.bin
     install -Dm 644 nvidia/gp104/gr/sw_method_init.bin $out/lib/firmware/nvidia/gp104/gr/sw_method_init.bin
     install -Dm 644 nvidia/gp104/gr/sw_ctx.bin $out/lib/firmware/nvidia/gp104/gr/sw_ctx.bin
     install -Dm 644 nvidia/gp104/gr/sw_bundle_init.bin $out/lib/firmware/nvidia/gp104/gr/sw_bundle_init.bin
     ...
     install -Dm 644 nvidia/gp104/gr/gpccs_bl.bin $out/lib/firmware/nvidia/gp104/gr/gpccs_bl.bin
     ...
     install -Dm 644 nvidia/gp104/gr/fecs_bl.bin $out/lib/firmware/nvidia/gp104/gr/fecs_bl.bin
     install -Dm 644 nvidia/gp104/acr/unload_bl.bin $out/lib/firmware/nvidia/gp104/acr/unload_bl.bin
     install -Dm 644 nvidia/gp104/acr/ucode_unload.bin $out/lib/firmware/nvidia/gp104/acr/ucode_unload.bin
     install -Dm 644 nvidia/gp104/acr/ucode_load.bin $out/lib/firmware/nvidia/gp104/acr/ucode_load.bin
     install -Dm 644 nvidia/gp104/acr/bl.bin $out/lib/firmware/nvidia/gp104/acr/bl.bin
     ...
     install -Dm 644 nvidia/gp102/gr/gpccs_bl.bin $out/lib/firmware/nvidia/gp102/gr/gpccs_bl.bin
     ...
     install -Dm 644 nvidia/gp102/gr/fecs_bl.bin $out/lib/firmware/nvidia/gp102/gr/fecs_bl.bin
     ...
     install -Dm 644 nvidia/gp100/gr/gpccs_bl.bin $out/lib/firmware/nvidia/gp100/gr/gpccs_bl.bin
     ...
     install -Dm 644 nvidia/gp100/gr/fecs_bl.bin $out/lib/firmware/nvidia/gp100/gr/fecs_bl.bin
     ...
     install -Dm 644 nvidia/gm20b/gr/sw_method_init.bin $out/lib/firmware/nvidia/gm20b/gr/sw_method_init.bin
     ...
     install -Dm 644 nvidia/gm206/gr/sw_nonctx.bin $out/lib/firmware/nvidia/gm206/gr/sw_nonctx.bin
     install -Dm 644 nvidia/gm206/gr/sw_method_init.bin $out/lib/firmware/nvidia/gm206/gr/sw_method_init.bin
     install -Dm 644 nvidia/gm206/gr/sw_ctx.bin $out/lib/firmware/nvidia/gm206/gr/sw_ctx.bin
     install -Dm 644 nvidia/gm206/gr/sw_bundle_init.bin $out/lib/firmware/nvidia/gm206/gr/sw_bundle_init.bin
     install -Dm 644 nvidia/gm206/gr/gpccs_sig.bin $out/lib/firmware/nvidia/gm206/gr/gpccs_sig.bin
     install -Dm 644 nvidia/gm206/gr/gpccs_inst.bin $out/lib/firmware/nvidia/gm206/gr/gpccs_inst.bin
     install -Dm 644 nvidia/gm206/gr/gpccs_data.bin $out/lib/firmware/nvidia/gm206/gr/gpccs_data.bin
     install -Dm 644 nvidia/gm206/gr/gpccs_bl.bin $out/lib/firmware/nvidia/gm206/gr/gpccs_bl.bin
     install -Dm 644 nvidia/gm206/gr/fecs_sig.bin $out/lib/firmware/nvidia/gm206/gr/fecs_sig.bin
     install -Dm 644 nvidia/gm206/gr/fecs_inst.bin $out/lib/firmware/nvidia/gm206/gr/fecs_inst.bin
     install -Dm 644 nvidia/gm206/gr/fecs_data.bin $out/lib/firmware/nvidia/gm206/gr/fecs_data.bin
     install -Dm 644 nvidia/gm206/gr/fecs_bl.bin $out/lib/firmware/nvidia/gm206/gr/fecs_bl.bin
     ...
     install -Dm 644 nvidia/gm206/acr/bl.bin $out/lib/firmware/nvidia/gm206/acr/bl.bin
     install -Dm 644 nvidia/gm204/gr/sw_nonctx.bin $out/lib/firmware/nvidia/gm204/gr/sw_nonctx.bin
     install -Dm 644 nvidia/gm204/gr/sw_method_init.bin $out/lib/firmware/nvidia/gm204/gr/sw_method_init.bin
     install -Dm 644 nvidia/gm204/gr/sw_ctx.bin $out/lib/firmware/nvidia/gm204/gr/sw_ctx.bin
     install -Dm 644 nvidia/gm204/gr/sw_bundle_init.bin $out/lib/firmware/nvidia/gm204/gr/sw_bundle_init.bin
     install -Dm 644 nvidia/gm204/gr/gpccs_sig.bin $out/lib/firmware/nvidia/gm204/gr/gpccs_sig.bin
     install -Dm 644 nvidia/gm204/gr/gpccs_inst.bin $out/lib/firmware/nvidia/gm204/gr/gpccs_inst.bin
     install -Dm 644 nvidia/gm204/gr/gpccs_data.bin $out/lib/firmware/nvidia/gm204/gr/gpccs_data.bin
     install -Dm 644 nvidia/gm204/gr/gpccs_bl.bin $out/lib/firmware/nvidia/gm204/gr/gpccs_bl.bin
     install -Dm 644 nvidia/gm204/gr/fecs_sig.bin $out/lib/firmware/nvidia/gm204/gr/fecs_sig.bin
     install -Dm 644 nvidia/gm204/gr/fecs_inst.bin $out/lib/firmware/nvidia/gm204/gr/fecs_inst.bin
     install -Dm 644 nvidia/gm204/gr/fecs_data.bin $out/lib/firmware/nvidia/gm204/gr/fecs_data.bin
     install -Dm 644 nvidia/gm204/gr/fecs_bl.bin $out/lib/firmware/nvidia/gm204/gr/fecs_bl.bin
     install -Dm 644 nvidia/gm204/acr/ucode_unload.bin $out/lib/firmware/nvidia/gm204/acr/ucode_unload.bin
     install -Dm 644 nvidia/gm204/acr/ucode_load.bin $out/lib/firmware/nvidia/gm204/acr/ucode_load.bin
     install -Dm 644 nvidia/gm204/acr/bl.bin $out/lib/firmware/nvidia/gm204/acr/bl.bin
